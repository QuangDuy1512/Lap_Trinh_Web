...
<body class="container mt-4">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Quản lý Categories</h4>
    ...
    <script>
        function editCategory(id) {
            fetch('${pageContext.request.contextPath}/admin/category/' + id)
                ...
                .then(category => {
                    ...
                    document.getElementById('editCategoryForm').action = '${pageContext.request.contextPath}/admin/category/edit/' + id;
        ...
        function deleteCategory(id) {
            if (confirm('Bạn có chắc chắn muốn xóa category này?')) {
                fetch('${pageContext.request.contextPath}/admin/category/delete/' + id, { 
                    method: 'POST',
                    headers: {
